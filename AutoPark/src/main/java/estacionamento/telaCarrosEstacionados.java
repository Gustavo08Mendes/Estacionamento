 ...
 * @author Gustavo
 */
public class telaCarrosEstacionados extends javax.swing.JFrame {

    /**
     * Creates new form telaTres
     */
    public telaCarrosEstacionados() {
        initComponents();
    }
        ...
        String sql = "SELECT * FROM cadastroveiculos WHERE Estacionado = 1";
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Veiculo", "Modelo", "Placa", "Hora de entrada"
            }
        ) {
        ...
        jLabel1.setText("Carros estacionados");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(telaCarrosEstacionados.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new telaCarrosEstacionados().setVisible(true);
            }
        });
    }
